export const sections = [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Then itâ€™s time for us to start on your minimum viable product. Thatâ€™s just a fancy term for a mockup, which doesnâ€™t include colors, images, or any other polished design elements, but captures the essential layout structure and functionality.`,
    ...
    },
    {
      ...
      title: "Build",
      paragraphs: [
        `Hereâ€™s where we get down to business.`,
        ...
        `Finishing the application doesnâ€™t mean weâ€™re done though, because we use extensive testing to guarantee compatibility with all intended devices.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `When construction comes to a close youâ€™re the first one to know. Weâ€™ll give our final demonstration to show off your shiny new software in the wild so you know exactly how it will look to your users.`,
        `When you say the word, we press the button and launch your project out to the public. Weâ€™re there to ensure everything goes to plan so you can start reaping the rewards of your technological investment immediately.`
      ]
    },
    {
